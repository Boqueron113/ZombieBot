...
ZONAS = {
    ...
    # ── ZONAS URBANAS ─────────────────────────────────────────────────────────
    "metro": {
        "nombre": "🚇 Metro Subterráneo",
        "descripcion": "Túneles oscuros llenos de zombies. El eco amplifica cada sonido.",
        "peligro": 3,
        "zombies": ["zombie_caminante", "zombie_corredor", "zombie_subterraneo"],
        "recursos": ["cable", "bateria", "municion", "piezas_metal"],
        "color": 0x2c2c54,
        "emoji": "🚇",
        "nivel_min": 2,
        "requiere_item": None,
    ...
    "estadio": {
        "nombre": "🏟️ Estadio Infestado",
        "descripcion": "Miles de aficionados zombificados atrapados en el campo.",
        "peligro": 4,
        "zombies": ["zombie_caminante", "zombie_corredor", "zombie_gordo", "zombie_titan"],
        "recursos": ["comida", "agua", "ropa_deportiva", "municion"],
        "color": 0x27ae60,
        "emoji": "🏟️",
        "nivel_min": 3,
        "requiere_item": None,
    ...
    "parque_atracciones": {
        ...
        "descripcion": "Luces que parpadean, música rota. Los zombies danzan entre las atracciones.",
        "peligro": 3,
        "zombies": ["zombie_caminante", "zombie_corredor", "zombie_payaso"],
        "recursos": ["comida", "cable", "bateria", "componentes_electronicos"],
        "color": 0xe91e8c,
        "emoji": "🎡",
        "nivel_min": 2,
        "requiere_item": None,
    ...
    "centro_comercial": {
        ...
        "descripcion": "El sueño del consumidor convertido en pesadilla. Tiendas saqueadas y hordas.",
        "peligro": 3,
        "zombies": ["zombie_caminante", "zombie_gordo", "zombie_corredor"],
        "recursos": ["ropa_deportiva", "comida", "cinta_adhesiva", "tela", "municion"],
        "color": 0xf39c12,
        "emoji": "🏬",
        "nivel_min": 2,
        "requiere_item": None,
    ...
    "bosque": {
        ...
        "descripcion": "La naturaleza ha reclamado lo que era suyo. Los zombies se camuflan entre los árboles.",
        "peligro": 2,
        "zombies": ["zombie_caminante", "zombie_corredor", "zombie_salvaje"],
        "recursos": ["madera", "cuero", "agua", "hierbas_medicinales"],
        "color": 0x1a5276,
        "emoji": "🌲",
        "nivel_min": 1,
        "requiere_item": None,
    ...
    "rio": {
        "nombre": "🏞️ Río Contaminado",
        "descripcion": "El agua fluye pero está infectada. Cuidado con los zombies acuáticos.",
        "peligro": 3,
        "zombies": ["zombie_caminante", "zombie_acuatico", "zombie_mutado"],
        "recursos": ["agua", "piezas_metal", "quimico_base", "hierbas_medicinales"],
        "color": 0x1a6b8a,
        "emoji": "🏞️",
        "nivel_min": 2,
        "requiere_item": None,
    ...
    "montana": {
        "nombre": "⛰️ Montaña Aislada",
        "descripcion": "Lejos de la ciudad. El frío mantiene a los zombies lentos pero resistentes.",
        "peligro": 4,
        "zombies": ["zombie_caminante", "zombie_congelado", "zombie_titan"],
        "recursos": ["piezas_metal", "cuero", "madera", "reliquia"],
        "color": 0x7f8c8d,
        "emoji": "⛰️",
        "nivel_min": 3,
        "requiere_item": None,
    ...
    "granja": {
        "nombre": "🌾 Granja Abandonada",
        "descripcion": "Animales zombificados y cultivos podridos. Recursos básicos aún disponibles.",
        "peligro": 2,
        "zombies": ["zombie_caminante", "zombie_granjero", "zombie_gordo"],
        "recursos": ["comida", "agua", "madera", "cuero", "hierbas_medicinales"],
        "color": 0x8b6914,
        "emoji": "🌾",
        "nivel_min": 1,
        "requiere_item": None,
    ...
    "prision": {
        "nombre": "⛓️ Prisión de Máxima Seguridad",
        "descripcion": "Los presos se convirtieron primero. Los guardias después. Nadie salió.",
        "peligro": 5,
        "zombies": ["zombie_preso", "zombie_guardia", "zombie_blindado", "zombie_titan"],
        "recursos": ["municion_pesada", "piezas_metal", "explosivo", "chaleco_kevlar"],
        "color": 0x2c3e50,
        "emoji": "⛓️",
        "nivel_min": 4,
        "requiere_item": None,
    ...
    "base_naval": {
        "nombre": "⚓ Base Naval",
        "descripcion": "Puerto militar abandonado. Armas navales y suministros de primera.",
        "peligro": 5,
        "zombies": ["zombie_marinero", "zombie_blindado", "zombie_titan", "zombie_jefe"],
        "recursos": ["rifle", "explosivo", "municion_pesada", "piezas_metal"],
        "color": 0x154360,
        "emoji": "⚓",
        "nivel_min": 4,
        "requiere_item": "mapa_naval",
    },
    "bunker_gobierno": {
        "nombre": "🏛️ Búnker del Gobierno",
        "descripcion": "El refugio de emergencia del gobierno. Tecnología avanzada y recursos únicos.",
        "peligro": 5,
        "zombies": ["zombie_agente", "zombie_blindado", "zombie_quimico", "zombie_jefe"],
        "recursos": ["componentes_electronicos", "bateria", "jeringilla", "morfina"],
        "color": 0x1b2631,
        "emoji": "🏛️",
        "nivel_min": 5,
        "requiere_item": "mapa_gobierno",
    },

    # ── ZONAS ESPECIALES ──────────────────────────────────────────────────────
    "nave_caida": {
        "nombre": "🛸 Nave Espacial Caída",
        "descripcion": "Nadie sabe de dónde vino. Los zombies cercanos parecen... diferentes.",
        "peligro": 5,
        "zombies": ["zombie_mutado", "zombie_alien", "zombie_titan"],
        "recursos": ["componentes_electronicos", "cristal", "reliquia", "bateria"],
        "color": 0x0b3d91,
        "emoji": "🛸",
        "nivel_min": 5,
        "requiere_item": "mapa_nave",
    },
    "catacumbas": {
        "nombre": "💀 Catacumbas Antiguas",
        "descripcion": "Laberinto de huesos bajo la ciudad. Los muertos más antiguos llevan siglos aquí.",
        "peligro": 4,
        "zombies": ["zombie_anciano", "zombie_esqueleto", "zombie_jefe"],
        "recursos": ["reliquia", "polvo_negro", "quimico_base", "morfina"],
        "color": 0x4a235a,
        "emoji": "💀",
        "nivel_min": 4,
        "requiere_item": "mapa_catacumbas",
    },
    "torre_control": {
        "nombre": "📡 Torre de Control",
        "descripcion": "Centro de comunicaciones militar. Desde aquí se puede ver toda la ciudad.",
        "peligro": 4,
        "zombies": ["zombie_tecnico", "zombie_corredor", "zombie_blindado"],
        "recursos": ["componentes_electronicos", "cable", "bateria", "cristal"],
        "color": 0x1f618d,
        "emoji": "📡",
        "nivel_min": 3,
        "requiere_item": None,
...
ZOMBIES = {
    ...
    # ── ZOMBIES NUEVOS ────────────────────────────────────────────────────────
    "zombie_subterraneo": {
        "nombre": "🕳️ Subterráneo",
        "vida": 40,
        "ataque": 18,
        "defensa": 6,
        "exp": 45,
        "tapas": (10, 22),
        "drop": {"cable": 0.4, "piezas_metal": 0.3, "municion": 0.3},
        "descripcion": "Adaptado a la oscuridad. Más rápido en los túneles."
    },
    "zombie_payaso": {
        "nombre": "🤡 Payaso Zombie",
        "vida": 35,
        "ataque": 20,
        "defensa": 2,
        "exp": 40,
        "tapas": (8, 18),
        "drop": {"cinta_adhesiva": 0.4, "comida": 0.3, "bateria": 0.2},
        "descripcion": "Aterrador. Ataca con una velocidad inesperada."
    },
    "zombie_salvaje": {
        "nombre": "🐺 Salvaje",
        "vida": 45,
        ...
        "exp": 50,
        "tapas": (12, 25),
        "drop": {"cuero": 0.5, "madera": 0.3, "hierbas_medicinales": 0.3},
        "descripcion": "Vivía en el bosque. Ahora caza supervivientes."
    },
    "zombie_acuatico": {
        "nombre": "🌊 Acuático",
        "vida": 55,
        ...
        "exp": 55,
        "tapas": (12, 28),
        "drop": {"agua": 0.4, "quimico_base": 0.3, "piezas_metal": 0.2},
        "descripcion": "Mutado por el agua contaminada. Piel resistente."
    },
    "zombie_congelado": {
        "nombre": "🧊 Congelado",
        "vida": 80,
        ...
        "exp": 65,
        "tapas": (15, 35),
        "drop": {"piezas_metal": 0.5, "cuero": 0.3, "reliquia": 0.15},
        "descripcion": "El frío lo ha preservado. Lento pero durísimo."
    },
    "zombie_granjero": {
        "nombre": "👨‍🌾 Granjero",
        "vida": 50,
        ...
        "exp": 35,
        "tapas": (8, 20),
        "drop": {"comida": 0.6, "madera": 0.4, "cuero": 0.3},
        "descripcion": "Lleva una azada oxidada. Peligroso en campo abierto."
    },
    "zombie_preso": {
        "nombre": "👤 Preso",
        "vida": 60,
        ...
        "exp": 55,
        "tapas": (12, 28),
        "drop": {"cinta_adhesiva": 0.4, "municion": 0.3, "piezas_metal": 0.3},
        "descripcion": "Tenía nada que perder en vida. Ahora tampoco."
    },
    "zombie_guardia": {
        "nombre": "💂 Guardia Zombie",
        "vida": 70,
        "ataque": 24,
        "defensa": 10,
        "exp": 70,
        "tapas": (18, 35),
        "drop": {"municion_pesada": 0.5, "chaleco_kevlar": 0.08, "piezas_metal": 0.3},
        "descripcion": "Armado hasta los dientes. Protege su zona."
    },
    "zombie_marinero": {
        "nombre": "⚓ Marinero Zombie",
        "vida": 65,
        "ataque": 21,
        "defensa": 8,
        "exp": 65,
        "tapas": (15, 32),
        "drop": {"municion_pesada": 0.4, "explosivo": 0.2, "piezas_metal": 0.4},
        "descripcion": "Sobreviviente naval. Sabe cómo luchar."
    },
    "zombie_agente": {
        "nombre": "🕵️ Agente Zombie",
        "vida": 75,
        "ataque": 28,
        "defensa": 12,
        "exp": 90,
        "tapas": (22, 45),
        "drop": {"componentes_electronicos": 0.4, "morfina": 0.3, "municion_pesada": 0.4},
        "descripcion": "Agente del gobierno. Entrenado para matar."
    },
    "zombie_mutado": {
        "nombre": "☣️ Mutado",
        "vida": 120,
        ...
        "exp": 100,
        "tapas": (30, 60),
        "drop": {"quimico_base": 0.5, "morfina": 0.3, "piezas_metal": 0.3},
        "descripcion": "Mutación extrema del virus. Más fuerte que cualquier otro."
    },
    "zombie_alien": {
        "nombre": "👽 Alien Zombie",
        "vida": 100,
        ...
        "exp": 120,
        "tapas": (35, 70),
        "drop": {"cristal": 0.5, "componentes_electronicos": 0.4, "reliquia": 0.3},
        "descripcion": "No es de este mundo. Nadie sabe qué lo infectó."
    },
    "zombie_esqueleto": {
        "nombre": "💀 Esqueleto Zombie",
        "vida": 45,
        "ataque": 16,
        "defensa": 3,
        "exp": 50,
        "tapas": (10, 25),
        "drop": {"reliquia": 0.5, "polvo_negro": 0.4, "quimico_base": 0.2},
        "descripcion": "Solo queda hueso. Muy antiguo pero activo."
    },
    "zombie_tecnico": {
        "nombre": "👨‍💻 Técnico Zombie",
        "vida": 40,
        "ataque": 15,
        "defensa": 4,
        "exp": 45,
        "tapas": (10, 22),
        "drop": {"componentes_electronicos": 0.6, "cable": 0.5, "bateria": 0.4},
        "descripcion": "Ingeniero de telecomunicaciones. Lleva gadgets encima."
    },
...
ITEMS = {
    ...
    "lanzagranadas": {
        ...
        "subtipo": "arma_fuego",
        "bonus_ataque": 55,
        "descripcion": "Destrucción masiva en área. +55 ataque.",
        "precio_compra": 0,
        "precio_venta": 275,
        "emoji": "💥"
    },
    "ballesta": {
        ...
        "subtipo": "cac",
        "bonus_ataque": 22,
        "descripcion": "Silenciosa y precisa. +22 ataque.",
        "precio_compra": 130,
        "precio_venta": 65,
        "emoji": "🏹"
    },
    "motosierra_electrica": {
        "nombre": "⛓️ Motosierra Eléctrica",
        "tipo": "arma",
        "subtipo": "cac",
        "bonus_ataque": 42,
        "descripcion": "Corta todo a su paso. +42 ataque. Crafteada.",
        "precio_compra": 0,
        "precio_venta": 210,
        "emoji": "⛓️"
    },
    "lanza_cohetes": {
        ...
        "subtipo": "arma_fuego",
        "bonus_ataque": 80,
        "descripcion": "El arma más destructiva. +80 ataque. Rarísima.",
        "precio_compra": 0,
        "precio_venta": 500,
        "emoji": "🚀"
    },
    "cuchillo_ceramica": {
        "nombre": "🗡️ Cuchillo de Cerámica",
        "tipo": "arma",
        "subtipo": "cac",
        "bonus_ataque": 14,
        "descripcion": "No detectado por sensores. +14 ataque.",
        "precio_compra": 55,
        "precio_venta": 27,
        "emoji": "🗡️"
    },
    "escopeta_recortada": {
        ...
        "subtipo": "arma_fuego",
        "bonus_ataque": 35,
        "descripcion": "Más manejable que la escopeta normal. +35 ataque.",
        "precio_compra": 0,
        "precio_venta": 175,
        "emoji": "💥"
    },
    "garrote": {
        ...
        "subtipo": "cac",
        "bonus_ataque": 11,
        "descripcion": "Simple pero efectivo. +11 ataque.",
        "precio_compra": 25,
        "precio_venta": 12,
        "emoji": "🔨"
    },
    "lanza_llamas_portatil": {
        "nombre": "🔥 Lanzallamas Portátil",
        "tipo": "arma",
        "subtipo": "arma_fuego",
        "bonus_ataque": 38,
        "descripcion": "Versión compacta del lanzallamas. +38 ataque.",
        "precio_compra": 0,
        "precio_venta": 190,
        "emoji": "🔥"
    },
    ...
    "hierbas_medicinales": {
        ...
        "efecto": "vida",
        "valor": 30,
        "descripcion": "Plantas curativas del bosque. Recupera 30 vida.",
        "precio_compra": 15,
        "precio_venta": 7,
        "emoji": "🌿"
    },
    "vendaje_profesional": {
        "nombre": "🩻 Vendaje Profesional",
        "tipo": "consumible",
        "efecto": "vida",
        "valor": 55,
        "descripcion": "Vendaje quirúrgico de alta calidad. Recupera 55 vida.",
        "precio_compra": 45,
        "precio_venta": 22,
        "emoji": "🩻"
    },
    "suero_vitaminas": {
        "nombre": "💪 Suero de Vitaminas",
        "tipo": "consumible",
        "efecto": "vida",
        "valor": 40,
        "descripcion": "Refuerza el sistema inmune. Recupera 40 vida.",
        "precio_compra": 30,
        "precio_venta": 15,
        "emoji": "💪"
    },
    "plasma_sangre": {
        "nombre": "🩸 Plasma Sanguíneo",
        "tipo": "consumible",
        "efecto": "vida",
        "valor": 90,
        "descripcion": "Transfusión de emergencia. Recupera 90 vida.",
        "precio_compra": 0,
        "precio_venta": 45,
        "emoji": "🩸"
    },
    "fruta_silvestre": {
        ...
        "efecto": "vida",
        "valor": 12,
        "descripcion": "Encontrada en el bosque. Recupera 12 vida.",
        "precio_compra": 6,
        "precio_venta": 3,
        "emoji": "🍎"
    },
    "racion_supervivencia": {
        "nombre": "📦 Ración de Supervivencia",
        "tipo": "consumible",
        "efecto": "vida",
        "valor": 45,
        "descripcion": "Kit completo de emergencia. Recupera 45 vida.",
        "precio_compra": 35,
        "precio_venta": 17,
        "emoji": "📦"
    },
    ...
    # ── ARMADURAS NUEVAS ──────────────────────────────────────────────────────
    "armadura_naval": {
        "nombre": "⚓ Armadura Naval",
        "tipo": "armadura",
        "bonus_defensa": 25,
        "descripcion": "Traje de combate naval. +25 defensa.",
        "precio_compra": 0,
        "precio_venta": 200,
        "emoji": "⚓"
    },
    "traje_hazmat": {
        "nombre": "☢️ Traje Hazmat",
        "tipo": "armadura",
        "bonus_defensa": 18,
        "descripcion": "Protección química total. +18 defensa.",
        "precio_compra": 0,
        "precio_venta": 150,
        "emoji": "☢️"
    },
    "escudo_riot": {
        "nombre": "🛡️ Escudo Antidisturbios",
        "tipo": "armadura",
        "bonus_defensa": 22,
        "descripcion": "Escudo policial de plexiglás reforzado. +22 defensa.",
        "precio_compra": 0,
        "precio_venta": 175,
        "emoji": "🛡️"
    },
    "casco_completo": {
        "nombre": "🪖 Casco Completo",
        "tipo": "armadura",
        "bonus_defensa": 14,
        "descripcion": "Casco con visera y protector de cuello. +14 defensa.",
        "precio_compra": 110,
        "precio_venta": 55,
        "emoji": "🪖"
    },
    "chaleco_ceramica": {
        "nombre": "🦺 Chaleco de Cerámica",
        "tipo": "armadura",
        "bonus_defensa": 28,
        "descripcion": "Placas de cerámica balística. +28 defensa.",
        "precio_compra": 0,
        "precio_venta": 230,
        "emoji": "🦺"
    },
    ...
    # ── MATERIALES NUEVOS ─────────────────────────────────────────────────────
    "hierbas_medicinales_mat": {
        "nombre": "🌿 Hierbas (material)",
        "tipo": "material",
        "descripcion": "Para crafting de consumibles médicos.",
        "precio_compra": 5,
        "precio_venta": 2,
        "emoji": "🌿"
    },
    "silicio": {
        "nombre": "💎 Silicio",
        "tipo": "material",
        "descripcion": "Para componentes avanzados.",
        "precio_compra": 18,
        "precio_venta": 9,
        "emoji": "💎"
    },
    "kevlar_bruto": {
        "nombre": "🟫 Kevlar Bruto",
        "tipo": "material",
        "descripcion": "Material para armaduras de alto nivel.",
        "precio_compra": 22,
        "precio_venta": 11,
        "emoji": "🟫"
    },
    "acido": {
        "nombre": "🧫 Ácido Industrial",
        "tipo": "material",
        "descripcion": "Corrosivo. Útil para armas y trampas.",
        "precio_compra": 14,
        "precio_venta": 7,
        "emoji": "🧫"
    },
    "fibra_carbono": {
        ...
        "tipo": "material",
        "descripcion": "Ligera y resistente. Para armaduras premium.",
        "precio_compra": 25,
        "precio_venta": 12,
        "emoji": "⬛"
    },
    "cohete_propulsor": {
        "nombre": "🚀 Propulsor",
        "tipo": "material",
        "descripcion": "Para crafting de lanza cohetes.",
        "precio_compra": 0,
        "precio_venta": 30,
        "emoji": "🚀"
    },
    "ropa_deportiva": {
        ...
        "tipo": "material",
        "descripcion": "Tela resistente de ropa deportiva.",
        "precio_compra": 6,
        "precio_venta": 3,
        "emoji": "👕"
    },
    ...
    "mapa_naval": {
        "nombre": "⚓ Mapa Naval",
        "tipo": "mapa_secreto",
        "zona_desbloquea": "base_naval",
        "descripcion": "Coordenadas de la base naval militar.",
        "precio_compra": 0,
        "precio_venta": 0,
        "emoji": "⚓"
    },
    "mapa_gobierno": {
        "nombre": "🏛️ Mapa del Gobierno",
        "tipo": "mapa_secreto",
        "zona_desbloquea": "bunker_gobierno",
        "descripcion": "Ubicación clasificada del búnker gubernamental.",
        "precio_compra": 0,
        "precio_venta": 0,
        "emoji": "🏛️"
    },
    "mapa_nave": {
        "nombre": "🛸 Mapa de la Nave",
        "tipo": "mapa_secreto",
        "zona_desbloquea": "nave_caida",
        "descripcion": "Coordenadas del lugar de impacto de la nave.",
        "precio_compra": 0,
        "precio_venta": 0,
        "emoji": "🛸"
    },
    "mapa_catacumbas": {
        "nombre": "💀 Mapa de las Catacumbas",
        "tipo": "mapa_secreto",
        "zona_desbloquea": "catacumbas",
        "descripcion": "Planos del laberinto subterráneo.",
        "precio_compra": 0,
        "precio_venta": 0,
        "emoji": "💀"
    },
...
TIENDA_ITEMS = [
    ...
    "hierbas_medicinales", "vendaje_profesional", "suero_vitaminas",
    "fruta_silvestre", "racion_supervivencia", "cafe_negro", "pan_duro",
    # Armas de fuego
    "pistola", "revolver", "escopeta", "subfusil", "ballesta",
    "garrote", "cuchillo", "cuchillo_ceramica",
    # Armas CaC
    "hacha", "machete", "lanza",
    # Armaduras
    "casco_militar", "casco_completo", "chaleco_kevlar", "traje_tatico",
    # Materiales básicos
    "municion", "municion_pesada", "tornillos", "cable",
    "tela", "madera", "gasolina", "bateria", "ropa_deportiva",
    "cristal", "quimico_base", "cuero", "cinta_adhesiva", "polvo_negro",
    "componentes_electronicos", "silicio", "kevlar_bruto", "acido",
    "fibra_carbono",
    # Equipamiento
    "mochila_grande",
    # Drogas
...
DROPS_MAPAS_SECRETOS = {
    ...
    "base_naval":    ("mapa_gobierno",     0.05),
    "prision":       ("mapa_naval",        0.06),
    "catacumbas":    ("mapa_nave",         0.04),
    "nave_caida":    ("mapa_catacumbas",   0.05),
}
